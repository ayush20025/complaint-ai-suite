...
ISSUE_RULES = {
    ...
    "Damaged shipment": {"department": "Logistics", "keywords": ["damaged package", "broken on arrival", "crushed box", "item cracked", "damaged", "arrived damaged", "broken item"], "task": "Arrange a replacement shipment, log a courier damage claim, and confirm return or disposal instructions.", "base_priority": "High"},
